...
const purchaseFractionsButtons = document.querySelectorAll('[id^="purchaseFractionsButton"]')

purchaseFractionsButtons.forEach((button) => {

  const stockID = button.id.slice(23)
  const form = document.querySelector('#purchaseFractionsForm' + stockID)
